...
if ( ! class_exists( 'Grafique_lite_Widget_Area' ) ) {

	/**
	 * Class Grafique_lite_Widget_Area.
	 */
	class Grafique_lite_Widget_Area {
		...
		function __construct() {
			...
			add_action( 'grafique_lite_render_widget_area', array( $this, 'render' ) );
		}
		...
		public function render( $area_id ) {
			...
			$area_id        = apply_filters( 'grafique_lite_rendering_current_widget_area', $area_id );
			...
			$classes = apply_filters( 'grafique_lite_widget_area_classes', $classes, $area_id );
	 ...
	 * @return object
	 */
	function grafique_lite_widget_area() {
		return Grafique_lite_Widget_Area::get_instance();
	}

	grafique_lite_widget_area();
}
