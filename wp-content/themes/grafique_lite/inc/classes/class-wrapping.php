 ...
 */
add_filter( 'template_include', array( 'Grafique_lite_Wrapping', 'wrap' ), 99 );
add_filter( 'grafique_lite_wrap_base', 'grafique_lite_wrap_base_cpts' );
 ...
 */
function grafique_lite_template_path() {
	return Grafique_lite_Wrapping::$main_template;
}
 ...
 */
function grafique_lite_template_base() {
	return Grafique_lite_Wrapping::$base;
}

if ( ! class_exists( 'Grafique_lite_Wrapping' ) ) {
	...
	class Grafique_lite_Wrapping {
		...
		/**
		 * Initialize new instance of Grafique_lite_Wrapping class by setting a variable for the $slug (which defaults to base)
		...
		public function __toString() {
			$this->templates = apply_filters( 'grafique_lite_wrap_' . $this->slug, $this->templates );
		 ...
		 * and $base as static variables in Grafique_lite_Wrapping class.
		 *
		 * @since 1.0.0
		...
		public static function wrap( $main ) {
			...
			return new Grafique_lite_Wrapping();
		}
	}
}
 ...
 */
function grafique_lite_wrap_base_cpts( $templates ) {
