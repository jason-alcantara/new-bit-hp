...
if ( ! class_exists( 'Grafique_lite_Elementor' ) ) {

	/**
	 * Define Grafique_lite_Elementor class
	 */
	class Grafique_lite_Elementor {
		...
		public function edit_scripts() {
			...
			$js_core = grafique_lite_theme()->get_core()->modules['cherry-js-core'];
			$ui      = grafique_lite_theme()->get_core()->init_module( 'cherry-ui-elements' );
			$builder = grafique_lite_theme()->get_core()->init_module( 'cherry-interface-builder' );
			...
			wp_localize_script( 'grafique_lite-edit', 'grafique_liteEditData', $this->get_data() );
		...
		public function get_widgets() {
			...
			foreach ( $wp_widget_factory->widgets as $widget ) {
				...
				if ( false === strpos( $widget->widget_id, 'grafique_lite' ) ) {
					continue;
				}
...
/**
 * Returns instance of Grafique_lite_Elementor
 *
 * @return object
 */
function grafique_lite_elementor() {
	return Grafique_lite_Elementor::get_instance();
}

grafique_lite_elementor();
