( function( $, data ) {
	...
	var grafique_liteElementor = {

		init: function() {

			if ( ! _.isEmpty( data.widgets ) ) {
				_.each( data.widgets, grafique_liteElementor.widgetsWalker );
			}

		},

		widgetsWalker: function( widget ) {
			elementor.hooks.addAction( 'panel/open_editor/widget/wp-widget-' + widget, grafique_liteElementor.initCb );
		},
	...
	grafique_liteElementor.init();

}( jQuery, window.grafique_liteEditData ) );
